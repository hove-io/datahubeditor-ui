...
export default class FeedVersionAccessibility extends Component<Props> {
  ...
  _renderIsochroneMessage () {
    ...
    if (version.isochrones && version.isochrones.features) {
      return <span>
        Déplacer le marqueur ou modifier la date/heure pour recalculer le service.<br />
        <Button
          bsStyle='success'
          bsSize='small'
      ...
      return 'Cliquez sur la carte ci-dessus pour afficher le service pour ce flux.'
    }
  }
