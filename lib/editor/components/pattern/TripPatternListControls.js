...
export default class TripPatternListControls extends Component<Props> {
  ...
  _onClickDeletePattern = () => {
    ...
    showConfirmModal({
      ...
      body: `Êtes-vous sûr de vouloir supprimer cet itinéraire ? Cela supprimera tous les services associés.`,
      onConfirm: () => {
      ...
      confirmButtonText: 'Supprimer l\'itinéraire'
    })
  }
  ...
  _onClickReversePattern = () => {
    ...
    showConfirmModal({
      ...
      body: `Êtes-vous sûr de vouloir inverser l'itinéraire ?`,
      onConfirm: () => {
    ...
    return (
      <div className='trip-pattern-controls'>
        <ButtonGroup
          ...
          <OverlayTrigger
            placement='bottom'
            overlay={<Tooltip id='tooltip'>Dupliquer l'itinéraire</Tooltip>}>
            <Button
              bsSize='small'
          ...
          <OverlayTrigger
            placement='bottom'
            overlay={<Tooltip id='tooltip'>Supprimer l'itinéraire</Tooltip>}>
            <Button
              bsSize='small'
        ...
        >
          <Icon type='plus' /> Nouvel itinéraire
        </Button>
      </div>
    )
  }
