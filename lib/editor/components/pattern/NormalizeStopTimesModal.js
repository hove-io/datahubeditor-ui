      ...
      <Modal show={this.props.show || this.state.show} onHide={this._onClose}>
        ...
        <Body>
          <p>
            ...
            départ pour <strong>tous les services</strong> de l'itinéraire pour se conformer 
            au temps de voyage et d'arrêt par défaut des arrêts de l'itinéraire.
          </p>
          ...
          <Alert bsStyle='warning'>
            {this.state.patternStopIndex === 0
              ...
              // correctly.
              ? <span>
                Les temps d'arrêt de <strong>tous les arrêts de l'itinéraire</strong> vont être
                normalisés.
              </span>
              : <span>
          ...
          <Alert bsStyle='info'>
            ...
            <small>
              ...
              services de l'itinéraire par les valeurs de l'arrêt 
              de l'itinéraire.
            </small>
          </Alert>
        </Body>
