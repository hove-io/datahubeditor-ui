          ...
          <Col sm={6}>
            ...
            <h4 style={{margin: '0px', marginTop: '5px'}}>
              ...
              <span title={patternName}>
                {patternName ? this.messages('patternsOn').replace('%truncatedPatternName%', truncate(patternName, 100)) : this.messages('selectPattern')}
              </span>
              <span title={calendarName}>
                {patternName && !calendarName
                  ...
                  : !patternName
                    ? ''
                    : this.messages('calendarName').replace('%truncatedCalendarName%', truncate(calendarName, 50))}
              </span>
            </h4>
          </Col>
          <Col sm={3}>
