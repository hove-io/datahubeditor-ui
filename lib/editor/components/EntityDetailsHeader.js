      ...
      <div className='entity-details-header'>
            ...
            {hasErrors
              ? <span>
                ...
                <OverlayTrigger
                  ...
                  <span style={{borderBottom: '2px dotted #000'}}>
        ...
        {activeComponent === 'route'
          ? <Nav style={{marginBottom: '5px'}} bsStyle='pills' justified>
            ...
            <OverlayTrigger placement='bottom' overlay={<Tooltip id='tooltip'>Les circulations définissent une séquence d'arrêts associée à un itinéraire.</Tooltip>}>
              <NavItem
                active={subComponent === 'trippattern'}
